        ...
        <div class="col-md-12">
            <div class="main-card mb-3 card">
                ...
                <div class="table-responsive">
                    ...
                    <table id="cart-table"class="align-middle mb-0 table table-borderless table-striped table-hover">
                        <thead>
                        <tr>
                            <!-- <th class="">#</th> -->
                            <th>Product</th>
...
<script>
    ...
    if ($.fn.DataTable.isDataTable('#cart-table')) {
        $('#cart-table').DataTable().destroy(); // Destroy the existing DataTable instance
        $('#cart-table').empty(); // Clear the table to prevent duplication
    }
