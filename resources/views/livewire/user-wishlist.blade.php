    ...
    <div class="row">
        <div class="col-md-12">
            <div class="main-card mb-3 card">
                <div class="card-header">Your Wishlist
                ...
                <div class="table-responsive">
                    ...
                    <table id="wishlist-table"class="align-middle mb-0 table table-borderless table-striped table-hover">
                        <thead>
                        <tr>
                            <!-- <th class="">#</th> -->
                            <th>Product</th>
...
<script>
    function loadtable() {
    if ($.fn.DataTable.isDataTable('#wishlist-table')) {
        $('#wishlist-table').DataTable().destroy(); // Destroy the existing DataTable instance
        $('#wishlist-table').empty(); // Clear the table to prevent duplication
    }
