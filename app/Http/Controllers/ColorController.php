...
class ColorController extends Controller
{
    ...
    // {
    //     $Color = Color::query()->orderBy('id', 'desc');

    //     return DataTables::of($Color)
           
    //         ->addColumn('action', function ($Color) {
    //             return '<a class="btn btn-sm btn-primary" href="' . route('edit-color', ['id' => $Color->id]) . '" wire:navigate><i class="fa-solid fa-pen-to-square"></i></a>
